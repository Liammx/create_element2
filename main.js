    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        <div class="img">
            ...
            <div class="rates">
                    ...
                    <h3><i class='bx bxs-package' ></i><span class="count">${arr[i].rating.count}</span></h3>
                </div>
...
function korzinka() {
    for (let i = 0; i < addItem.length; i++) {
        addItem[i].addEventListener('click', () => {
            tovar.innerHTML++
            addItem[i].innerHTML = 'Добавлено'
            addItem[i].style.backgroundColor = '#1F86FF'
        })
        vse.innerHTML = addItem.length
    }
}
